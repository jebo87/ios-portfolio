...
class JBItemInfoView: UIView {

    let symbolImageView = UIImageView()
    let titleLabel = JBTitleLabel(textAlignment: .center, fontSize: 14)
    let countLabel = JBTitleLabel(textAlignment: .center, fontSize: 14)
